...
<div class="col-xs-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-xs-12">
                <a href="javascript:void(0)" class="btn btn-danger" onclick="activate_users('user_type', '2')">Delete</a>
                <a href="<?php echo frontend_url() . 'usertype/add' ?>" class="btn btn-success" >Add</a>
            </div>

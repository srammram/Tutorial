                ...
                <div class="login-form row">
                    <div class="col-sm-12 text-center login-header">
                      <?php /*?>  <i class="login-logo fa fa-connectdevelop fa-5x"></i> <?pph */?>
                        <a class="landing_logo logo" title="pos"><img src="<?php echo load_lib()?>theme/images/logo.png" /></a>
                    </div>
                    
                    <div class="col-sm-12">
                    <div class="alert fresh-color log_alert" role="alert" style="display:none;;">
</div>              
                        ...
                        <div id="forgot_frm" style="">
                            ...
                            <div class="login-footer">
                                <span class="text-right"><a href="#" class="color-white">&larr; Back</a></span>
                            </div>
                        </div>
                    </div>
                </div>

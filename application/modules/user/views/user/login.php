...
<head>
    ...
    <script>
      var SITE_URL =  "<?php echo frontend_url('user/');?>";
    </script>
</head>
                        ...
                        <div id="login_frm" style="">
                            <div class="login-body">
                                <div class="progress " id="login-progress" style="display:none;;">
                                   ...
                                   <?php echo form_open(frontend_url('user/login'),'id="login_form" autocomplete= "'.form_autocomplte().'" ');?>
                                        ...
                                        <?php echo form_submit('submit','Login',' class="btn btn-info" id="log_submit" ' )?>
											...
											<a class="text-link color-white" href="<?php echo frontend_url('user/register');?>" role="button">Create an account?</a>
                                        </div>
                                  <?php echo form_close();?>

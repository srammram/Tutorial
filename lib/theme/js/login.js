...
function updatemenu(edit_id) {
    ...
    $.ajax({
        ...
        data: {edit_id: edit_id, menus: menus, menulink: menulink, menusort: menusort, menuicon: menuicon, edit_status: edit_status},
        dataType: 'json',
        type: 'post',
        success: function (output) {
            $('#err_message').html(output.message);
...
function updatesubmenu(edit_id) {
    ...
    $.ajax({
        ...
        data: {edit_id: edit_id, menus: menus, menulink: menulink, menusort: menusort, parent_id: parent_id, edit_status: edit_status},
        dataType: 'json',
        type: 'post',
        success: function (output) {
            $('#err_message').html(output.message);
